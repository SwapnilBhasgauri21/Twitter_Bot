...
NBA_sql = mysql.connector.connect(host = 'localhost', user = 'root',passwd = '@Lamborgini1998', database = 'NBA')
...
main_df.to_csv(r'C:\Users\Swapnil\OneDrive\Desktop\Semester1\DMDD\Tweets_Details.csv')
...
hash_df.to_csv(r'C:\Users\Swapnil\OneDrive\Desktop\Semester1\DMDD\Tweet_Tags.csv')